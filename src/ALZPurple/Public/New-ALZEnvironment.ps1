function New-ALZEnvironment {
    ...
    if ($PSCmdlet.ShouldProcess("ALZ-Bicep module configuration", "modify")) {
        ...
        if (-not $localSourcePackagePath) {
            ...
            Get-ALZLocalRelease -directoryForReleases $alzEnvironmentDestinationInternalCode -localSourceDirectory $localSourcePackagePath -releaseVersion $alzBicepVersion | Out-String | Write-Verbose
        }
